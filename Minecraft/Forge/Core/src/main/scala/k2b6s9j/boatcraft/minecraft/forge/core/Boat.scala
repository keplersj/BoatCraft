...
object Boat {
  ...
  class RenderCustomBoat extends RenderBoat with IItemRenderer {
    ...
    override def doRender(p1: Entity, p2: Double, p3: Double, p4: Double, p5: Float, p6: Float): Unit = {

    }

    override def getEntityTexture(p1: Entity): ResourceLocation = new ResourceLocation("textures/entity/boat.png")
