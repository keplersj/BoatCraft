...
public class BoatOakHopper extends ItemBoat {
	
	public static int ID;
	public static int shiftedID;
	
	public BoatOakHopper(int id) {
		super(id);
		setUnlocalizedName("boat.wood.oak.hopper");
        func_111206_d("boatcraft:boat.wood.oak.hopper");
    	GameRegistry.registerItem(this, "Oak Hopper Boat");
        ...
        else
        {
            ...
            else
            {
                if (movingobjectposition.typeOfHit == EnumMovingObjectType.TILE)
                {
                    ...
                    EntityBoatOakHopper entityboat = new EntityBoatOakHopper(par2World, (double)((float)i + 0.5F), (double)((float)j + 1.0F), (double)((float)k + 0.5F));
