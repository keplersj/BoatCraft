...
public class BoatJungleTNT extends ItemCustomBoat {
	
	public static int ID;
	public static int shiftedID;
	
	public BoatJungleTNT(int id) {
		super(id);
		setUnlocalizedName("boat.wood.jungle.tnt");
        func_111206_d("boatcraft:boat.wood.jungle.tnt");
    	GameRegistry.registerItem(this, "Jungle TNT Boat");
    	...
    	OreDictionary.registerOre("boatJungleTNT", new ItemStack(this));
	}
	
	@Override
	public EntityCustomBoat getEntity(World world, int x, int y, int z) {
		EntityBoatJungleTNT entity = new EntityBoatJungleTNT(world, (double)((float)x + 0.5F), (double)((float)y + 1.0F), (double)((float)z + 0.5F));
		return entity;
	}
}
