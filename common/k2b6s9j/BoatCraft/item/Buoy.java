package k2b6s9j.BoatCraft.item;
...
public class Buoy extends ItemBoat {
	...
	public Buoy(int id) {
        ...
        func_111206_d("boatcraft:buoy");
    	GameRegistry.registerItem(this, "Buoy");
        ...
        else
        {
            ...
            else
            {
                if (movingobjectposition.typeOfHit == EnumMovingObjectType.TILE)
                {
                    ...
                    EntityBuoy entityboat = new EntityBuoy(par2World, (double)((float)i + 0.5F), (double)((float)j + 1.0F), (double)((float)k + 0.5F));
