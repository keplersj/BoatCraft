...
public class RenderOakWoodBoat extends Render implements IItemRenderer {
	...
	public void renderBoat(EntityBoatOak par1EntityBoat, double par2, double par4, double par6, float par8, float par9)
    {
        GL11.glPushMatrix();
	...
	public void doRender(Entity entity, double d0, double d1, double d2,
			float f, float f1) {
    	this.renderBoat((EntityBoatOak)entity, d0, d1, d2, f, f1);
		
	}

    protected ResourceLocation func_110781_a(EntityBoatOak par1Entity)
    {
        return texture;
    }
    ...
    {
        return this.func_110781_a((EntityBoatOak)par1Entity);
    }
