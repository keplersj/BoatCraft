...
public class RenderTNTBoat extends Render implements IItemRenderer {
     ...
     * Renders the Boat.
     */
    public void renderTheBoat(EntityBoatOakTNT boat, double par2, double par4, double par6, float par8, float par9)
    {
    	GL11.glPushMatrix();
    ...
    protected ResourceLocation func_110803_a(EntityBoatOakTNT boat)
    {
        return texture;
    }
     ...
     */
    protected void renderBlockInBoat(EntityBoatOakTNT boat, float par2, Block par3Block, int par4)
    {
    ...
    {
        return this.func_110803_a((EntityBoatOakTNT)par1Entity);
    }
    ...
    {
        this.renderTheBoat((EntityBoatOakTNT)par1Entity, par2, par4, par6, par8, par9);
    }
