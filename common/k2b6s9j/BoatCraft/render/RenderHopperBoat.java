...
public class RenderHopperBoat extends Render implements IItemRenderer {
	...
	private EntityBoatOakHopper entity;
     ...
     * Renders the Boat.
     */
    public void renderTheBoat(EntityBoatOakHopper boat, double par2, double par4, double par6, float par8, float par9)
    {
    	GL11.glPushMatrix();
    ...
    protected ResourceLocation func_110803_a(EntityBoatOakHopper boat)
    {
        return texture;
    }
     ...
     */
    protected void renderBlockInBoat(EntityBoatOakHopper boat, float par2, Block par3Block, int par4)
    {
    ...
    {
        return this.func_110803_a((EntityBoatOakHopper)par1Entity);
    }
    ...
    {
        this.renderTheBoat((EntityBoatOakHopper)par1Entity, par2, par4, par6, par8, par9);
    }
