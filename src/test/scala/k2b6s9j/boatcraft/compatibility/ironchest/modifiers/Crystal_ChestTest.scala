...
class Crystal_ChestTest extends FlatSpec with Matchers with BeforeAndAfter {
  ...
  it should "have the metadata of a Crystal Chest" in {
    modifier.getMeta shouldBe IronChestType.CRYSTAL.ordinal
  }

  it should "be called \"Crystal Chest\"." in {
    modifier.getName shouldBe "Crystal Chest"
  }
