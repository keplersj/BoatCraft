...
import k2b6s9j.boatcraft.api.traits.examples.{ExampleMaterial, ExampleMaterial2}
...
class MultipleMaterialRegistryTest extends FlatSpec with Matchers with BeforeAndAfter {
  ...
  "All Materials" should "be added to the registered Materials map." in {
    ...
    MaterialRegistry.materials.asInstanceOf[util.HashMap[AnyRef, AnyRef]].toMap should contain ("test2", ExampleMaterial2)
  }
