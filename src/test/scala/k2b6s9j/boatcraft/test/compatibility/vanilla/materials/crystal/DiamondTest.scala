...
class DiamondTest extends FlatSpec with Matchers with BeforeAndAfter {
  ...
  it should "have a defined texture." in {
    material.getTexture shouldBe new ResourceLocation("boatcraft", "textures/entity/boat/vanilla/crystal/diamond.png")
  }

  it should "be named \"Diamond\"." in {
    material.getName shouldBe "Diamond"
  }
