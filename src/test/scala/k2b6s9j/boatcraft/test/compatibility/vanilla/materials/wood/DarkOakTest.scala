...
class DarkOakTest extends FlatSpec with Matchers with BeforeAndAfter {
  ...
  it should "have a defined texture." in {
    material.getTexture shouldBe new ResourceLocation("boatcraft", "textures/entity/boat/vanilla/wood/dark_oak.png")
  }

  it should "be named \"Dark Oak\"." in {
    material.getName shouldBe "Dark Oak"
  }
