...
object LanguageRegistry {
    ...
    def RegisterName() {
      ...
      cpw.mods.fml.common.registry.LanguageRegistry.addName(Item.boat, "Vanilla Boat")
        ...
        if (ConfigRegistry.OreDictWoodBoat) {
          cpw.mods.fml.common.registry.LanguageRegistry.addName(classOf[oak.Empty.Item], "Wooden Boat")
          cpw.mods.fml.common.registry.LanguageRegistry.addName(classOf[oak.Chest.Item], "Chest Boat")
          cpw.mods.fml.common.registry.LanguageRegistry.addName(classOf[oak.Furnace.Item], "Furnace Boat")
          cpw.mods.fml.common.registry.LanguageRegistry.addName(classOf[oak.Hopper.Item], "Hopper Boat")
          cpw.mods.fml.common.registry.LanguageRegistry.addName(classOf[oak.TNT.Item], "TNT Boat")
        }
    }
}
