...
public class BoatJungleFurnace extends ItemCustomBoat {
	
	public static int ID;
	public static int shiftedID;
	
	public BoatJungleFurnace(int id) {
		super(id);
		setUnlocalizedName("boat.wood.jungle.furnace");
        func_111206_d("boatcraft:boat.wood.jungle.furnace");
    	GameRegistry.registerItem(this, "Jungle Furnace Boat");
    	...
    	OreDictionary.registerOre("boatJungleFurnace", new ItemStack(this));
	}
	
	@Override
	public EntityCustomBoat getEntity(World world, int x, int y, int z) {
		EntityBoatJungleFurnace entity = new EntityBoatJungleFurnace(world, (double)((float)x + 0.5F), (double)((float)y + 1.0F), (double)((float)z + 0.5F));
		return entity;
	}
}
