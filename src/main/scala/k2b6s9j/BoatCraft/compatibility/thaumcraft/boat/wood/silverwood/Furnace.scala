...
object Furnace {
  ...
  class Entity(world: World) extends EntityCustomBoat(world) with Materials.Entity.Wood.Silverwood with Modifiers.Entity.Furnace {
  ...
  class Render extends RenderBoat with Materials.Render.Wood.Silverwood with Modifiers.Render.Furnace {
