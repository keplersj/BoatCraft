package k2b6s9j.BoatCraft.compatibility.forestry.item.boat.wood.larch;

import cpw.mods.fml.common.registry.GameRegistry;
import k2b6s9j.BoatCraft.compatibility.forestry.entity.boat.wood.larch.EntityBoatLarch;
