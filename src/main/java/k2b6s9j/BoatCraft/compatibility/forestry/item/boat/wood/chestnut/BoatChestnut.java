package k2b6s9j.BoatCraft.compatibility.forestry.item.boat.wood.chestnut;

import cpw.mods.fml.common.registry.GameRegistry;
import k2b6s9j.BoatCraft.compatibility.forestry.entity.boat.wood.chestnut.EntityBoatChestnut;
