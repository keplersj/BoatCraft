...
public class EntityBoatAcaciaHopper extends EntityBoatContainer implements Hopper {
	
	private int transferTicker = -1;
	public BoatAcaciaHopper item;
	
	public EntityBoatAcaciaHopper(World par1World)
    {
        super(par1World);
    }

    public EntityBoatAcaciaHopper(World par1World, double par2, double par4, double par6)
    {
